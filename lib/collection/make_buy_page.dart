        ...
        selectedCategoryWidgets.add(
          Container(
            ...
            child: Row(
              ...
              children: [
                Container(
                  width: select_category[key] == "기타" ? size.width*0.2 : size.width*0.35,
                  padding: select_category[key] == "기타" ? const EdgeInsets.all(0) : EdgeInsets.all(size.width*0.05),
                  margin: select_category[key] == "기타" ? EdgeInsets.only(left: size.width*0.05, right: size.width*0.10) : const EdgeInsets.all(0),
